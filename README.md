...
[![Kotlin](https://img.shields.io/badge/Kotlin-1.8.0-RC2-blue.svg?logo=kotlin)](http://kotlinlang.org)
...
Latest version: `1.0-v3-alpha3-b1`
...
| --------------------------------------------------------------- |-------------|------------| ----------- | ------------- | --------- |--------------------|
| ![Status](https://img.shields.io/badge/-experimental-important) | `Java 19`   | `1.8.0-RC2` | `22.3.x`    | `3.7.x`       | `18.x`    | `3.21.11`/`1.51.0` |
