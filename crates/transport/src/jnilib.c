...
JNIEXPORT jboolean JNICALL Java_io_netty_internal_tcnative_Native_isStatic(JNIEnv *env, jclass *clazz) {
...
JNIEXPORT jint JNICALL Java_io_netty_internal_tcnative_Native_initializeStatic(JNIEnv *env, jclass *reserved) {
#ifdef ELIDE_GVM_STATIC
  JavaVM *vm;
