...
@SharedImmutable internal val UUID_HYPHEN_INDICES = listOf(8, 13, 18, 23)

// UUID chars arranged from smallest to largest, so they can be indexed by their byte representations
@SharedImmutable internal val UUID_CHARS = ('0'..'9') + ('a'..'f')
 ...
 * @sample elide.util.uuid.UuidTest.variants
 ...
 *
 * Version 4 UUIDs are randomly generated from the best available random source. The selection of that source is depends
 * on the platform. Some systems may be bad at generating sufficient entropy, e.g. virtual machines, and this might lead
 * to collisions faster than desired. Version 5 may be used if this is the case and no other measures are possible to
 * increase the entropy of the random source of the platform.
 *
