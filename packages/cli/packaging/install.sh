#!/bin/bash
set -e;set +x;TOOL_REVISION="1.0-v3-alpha3-b4";INSTALLER_VERSION="v0.7";TOOL="cli";VERSION="v1";RELEASE="snapshot";
...
echo -e "";
echo -e "Copyright 2022, Sam Gammon and the Elide Project Authors.";
exit 0;
fi
if [[ "$@" == *"version"* ]]; then
