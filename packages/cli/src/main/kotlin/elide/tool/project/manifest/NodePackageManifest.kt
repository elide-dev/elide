 ...
 */
@JvmRecord @Serializable data class NodePackageManifest(
  ...
  @Serializable sealed interface ProjectBugs {
    ...
    /** TBD. */
    @Serializable @JvmRecord data class ProjectBugsConfig(
      val url: String? = null,
  ...
  @Serializable sealed interface ProjectFunding {
    ...
    data class ProjectMultiFunding(val list: List<ProjectFundingEntry>? = null) : ProjectFunding

    /** TBD. */
    @Serializable @JvmRecord
    data class ProjectSingleFunding(val entry: ProjectFundingEntry? = null) : ProjectFunding
  }

  /** Describes a string project bin or map of bins. */
  @Serializable sealed interface ProjectBins {
    /** TBD. */
    @Serializable @JvmRecord data class ProjectBinString(val string: String? = null) : ProjectBins
