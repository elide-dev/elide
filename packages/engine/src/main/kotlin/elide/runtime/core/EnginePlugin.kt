 ...
 */
@DelicateElideApi
public interface EnginePlugin<Config : Any, Instance : Any> {
  /**
   ...
   */
  @DelicateElideApi
  @JvmInline public value class Key<@Suppress("unused") T>(public val id: String)
  ...
  public interface InstallationScope {
     ...
     */
    public fun registerBundle(resource: URL)

    /**
     * Return the current list of resources which should be made available for this plug-in; the resulting list is a
     * read-only copy.
     *
     * @return List of registered bundles
     */
    public fun registeredBundles(): List<URL>
  }
