...
@JvmRecord public data class ModuleInfo private constructor (
  ...
  public companion object {
    private val allModuleInfos = ConcurrentSkipListMap<ModuleId, ModuleInfo>()
    ...
    @JvmStatic public fun from(req: ModuleRequest): ModuleInfo = requireNotNull(allModuleInfos[
      req.specifier.toString().substringAfter(':')
    ]) {
