...
import elide.tool.MultiPath.MultiPathContainer
 ...
 */
@Serializable
public sealed class AbstractJvmMultiPathContainer : MultiPathContainer<JvmMultiPathEntry, JvmMultiPath>
...
@Serializable public class JvmMultiPathContainer(
  ...
  internal companion object {
    ...
    @JvmStatic fun empty(): JvmMultiPathContainer = JvmMultiPathContainer(role = CLASSPATH)
...
@Serializable public class MutableJvmMultiPathContainer(
  ...
  override fun asPathSequence(): Sequence<Path> = paths.asSequence().map { it.path }
  override fun iterator(): MutableIterator<Entry> = paths.toMutableList().iterator()
  ...
  override fun build(): MultiPathContainer<JvmMultiPathEntry, JvmMultiPath> {
    TODO("Not yet implemented")
  }
  ...
  internal companion object {
    ...
    @JvmStatic fun empty(): MutableJvmMultiPathContainer = MutableJvmMultiPathContainer(role = CLASSPATH)
...
public class Classpath private constructor (
  private val classpath: JvmMultiPathContainer = JvmMultiPathContainer(role = CLASSPATH),
) : MultiPathContainer<JvmMultiPathEntry, JvmMultiPath> by classpath {
  ...
  public companion object {
    ...
    @JvmStatic public fun of(first: Path, vararg additional: Path): Classpath = Classpath(
      JvmMultiPathContainer.of(CLASSPATH, first, *additional)
    )
...
public class MutableClasspath private constructor (
  private val classpath: MutableJvmMultiPathContainer = MutableJvmMultiPathContainer(role = CLASSPATH),
  ...
  override fun contains(element: Entry): Boolean = classpath.contains(element)
  override fun contains(str: String): Boolean = classpath.contains(str)
  override fun containsAll(elements: Collection<Entry>): Boolean = classpath.containsAll(elements)
  override fun iterator(): MutableIterator<Entry> = classpath.iterator()
  override fun add(element: Entry): Boolean = classpath.add(element)
  override fun addAll(elements: Collection<Entry>): Boolean = classpath.addAll(elements)
  override fun remove(element: Entry): Boolean = classpath.remove(element)
  ...
  public companion object {
    ...
    @JvmStatic public fun of(first: Path, vararg additional: Path): MutableClasspath = MutableClasspath(
      MutableJvmMultiPathContainer.of(CLASSPATH, first, *additional)
    )

    /** Create a [collection] of paths. */
    @JvmStatic public fun from(collection: Collection<Path>): MutableClasspath = MutableClasspath(
      MutableJvmMultiPathContainer.from(CLASSPATH, collection)
    )
  }
}
...
public class Modulepath private constructor (
  private val modulepath: JvmMultiPathContainer = JvmMultiPathContainer(role = MODULEPATH),
) : MultiPathContainer<JvmMultiPathEntry, JvmMultiPath> by modulepath {
  ...
  public companion object {
    ...
    @JvmStatic public fun of(first: Path, vararg additional: Path): Modulepath = Modulepath(
      JvmMultiPathContainer.of(MODULEPATH, first, *additional)
    )

    /** Create a [collection] of paths. */
    @JvmStatic public fun from(collection: Collection<Path>): Modulepath = Modulepath(
      JvmMultiPathContainer.from(MODULEPATH, collection)
    )
  }
}
...
public class MutableModulepath private constructor (
  private val modulepath: MutableJvmMultiPathContainer = MutableJvmMultiPathContainer(role = MODULEPATH),
  ...
  override fun contains(element: Entry): Boolean = modulepath.contains(element)
  override fun contains(str: String): Boolean = modulepath.contains(str)
  override fun containsAll(elements: Collection<Entry>): Boolean = modulepath.containsAll(elements)
  override fun iterator(): MutableIterator<Entry> = modulepath.iterator()
  override fun add(element: Entry): Boolean = modulepath.add(element)
  override fun addAll(elements: Collection<Entry>): Boolean = modulepath.addAll(elements)
  override fun remove(element: Entry): Boolean = modulepath.remove(element)
  ...
  public companion object {
    ...
    @JvmStatic public fun of(first: Path, vararg additional: Path): MutableModulepath = MutableModulepath(
      MutableJvmMultiPathContainer.of(MODULEPATH, first, *additional)
    )

    /** Create a [collection] of paths. */
    @JvmStatic public fun from(collection: Collection<Path>): MutableModulepath = MutableModulepath(
      MutableJvmMultiPathContainer.from(MODULEPATH, collection)
    )
  }
}
