...
public open external class ExtensionFieldInfo<T>(
  fieldIndex: Number,
  fieldName: `T$2`,
  ctor: Any,
...
public open external class ExtensionFieldBinaryInfo<T>(
  fieldInfo: ExtensionFieldInfo<T>,
  binaryReaderFn: BinaryRead,
  binaryWriterFn: BinaryWrite,
  opt_binaryMessageSerializeFn: (msg: Message, writer: BinaryWriter) -> Unit,
...
public open external class BinaryIterator(
