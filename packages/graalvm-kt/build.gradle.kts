...
dependencies {
  ...
  implementation(libs.kotlin.kapt.runtime)
  implementation(libs.kotlin.kapt.embedded)
  ...
  embeddedKotlin(libs.kotlin.kapt.runtime)
  embeddedKotlin(libs.kotlin.kapt.embedded)
