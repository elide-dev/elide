...
/**
 * Node for invoking objects and closures as functions ($obj(), $closure()). Handles PhpClosure
 * objects and objects with __invoke magic method.
 */
public final class PhpInvokeNode extends PhpExpressionNode {

  @Child private PhpExpressionNode callableNode;
  ...
  public Object execute(VirtualFrame frame) {
        ...
        if (argNode instanceof PhpSpreadArgumentNode) {
          ...
          if (value instanceof PhpArray) {
            ...
            throw new RuntimeException(
                "Cannot use spread operator on non-array value in closure call");
          }
        } else {
    ...
    if (callableValue instanceof PhpObject) {
      ...
      if (phpClass.hasMethod("__invoke")) {
        ...
        throw new RuntimeException(
            "Object of class " + phpClass.getName() + " is not callable (missing __invoke method)");
      }
    }
