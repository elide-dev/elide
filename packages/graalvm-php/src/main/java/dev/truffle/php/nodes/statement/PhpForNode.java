...
public final class PhpForNode extends PhpStatementNode {
    ...
    @Child
    private PhpStatementNode init;

    @Child
    private LoopNode loopNode;

    public PhpForNode(PhpStatementNode init, PhpExpressionNode condition, PhpExpressionNode increment, PhpStatementNode body) {
        this.init = init;
        this.loopNode = Truffle.getRuntime().createLoopNode(new PhpForRepeatingNode(condition, increment, body));
    }
    ...
    private static final class PhpForRepeatingNode extends Node implements RepeatingNode {
        ...
        @Child
        private PhpExpressionNode increment;

        @Child
        private PhpStatementNode body;

        PhpForRepeatingNode(PhpExpressionNode condition, PhpExpressionNode increment, PhpStatementNode body) {
