...
/**
 * Node for PHP global statement.
 * Syntax: global $varname;
 *
 * Makes a local variable an alias to a global variable by storing
 * the same PhpReference in both the local and global frame slots.
 */
