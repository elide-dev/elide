...
public final class PhpIfNode extends PhpStatementNode {
    ...
    @Child
    private PhpStatementNode thenBranch;

    @Child
    private PhpStatementNode elseBranch;

    private final ConditionProfile conditionProfile = ConditionProfile.createCountingProfile();

    public PhpIfNode(PhpExpressionNode condition, PhpStatementNode thenBranch, PhpStatementNode elseBranch) {
    ...
    /**
     * Convert a PHP value to boolean using PHP truthiness rules.
     * - null, false, 0, 0.0, "", "0" are falsy
