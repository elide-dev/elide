...
/**
 * AST node for require statement.
 * Includes and executes a PHP file. Throws fatal error if file not found.
 */
public final class PhpRequireNode extends PhpStatementNode {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        if (!file.exists()) {
            throw new RuntimeException("Failed opening required '" + path + "': No such file or directory");
        }
