 ...
 * Evaluates an expression and executes code based on matching case values.
 * Supports fall-through behavior and default case.
 */
public final class PhpSwitchNode extends PhpStatementNode {

    @Child
    private PhpExpressionNode switchExpression;

    @Children
    private final PhpExpressionNode[] caseValues;

    @Children
    private final PhpStatementNode[] allStatements;
    ...
    public PhpSwitchNode(PhpExpressionNode switchExpression, CaseClause[] cases, int defaultCaseIndex) {
     ...
     * This is just a data holder, not a Node.
     */
    public static final class CaseClause {
        ...
        public CaseClause(PhpExpressionNode valueNode, PhpStatementNode[] statements, boolean isDefault) {
