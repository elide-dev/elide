 ...
 *
 * Manages the current namespace and use statements (imports) to properly
 * resolve class, function, and constant names according to PHP namespace rules.
 *
 * <p>PHP Namespace Rules:
 * <ul>
 *   <li>Fully qualified names start with \ (e.g., \MyApp\Models\User)</li>
 *   <li>Qualified names contain \ but don't start with it (e.g., Models\User)</li>
 *   <li>Unqualified names don't contain \ (e.g., User)</li>
 * </ul>
 */
public final class PhpNamespaceContext {
     ...
     * Example: "MyApp\\Models\\User" -> "User"
     *
