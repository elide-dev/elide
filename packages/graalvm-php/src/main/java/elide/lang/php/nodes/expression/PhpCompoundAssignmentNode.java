 ...
 *
 * <p>These operators combine an operation with assignment: $x += 5 is equivalent to $x = $x + 5
 */
public final class PhpCompoundAssignmentNode extends PhpExpressionNode {
  ...
  public PhpCompoundAssignmentNode(
      String variableName, int variableSlot, CompoundOp operation, PhpExpressionNode rightNode) {
