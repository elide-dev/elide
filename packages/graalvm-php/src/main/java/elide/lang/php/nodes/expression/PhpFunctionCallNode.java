...
import elide.lang.php.runtime.PhpFunction;
...
public final class PhpFunctionCallNode extends PhpExpressionNode {
  ...
  @Children private final PhpExpressionNode[] arguments;
      ...
      if (argNode instanceof PhpSpreadArgumentNode) {
        ...
        if (value instanceof PhpArray) {
          ...
          throw new RuntimeException(
              "Cannot use spread operator on non-array value in function " + functionName);
        }
      } else {
