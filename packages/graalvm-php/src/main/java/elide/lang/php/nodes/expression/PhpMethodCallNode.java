...
public final class PhpMethodCallNode extends PhpExpressionNode {
  ...
  private final String
      callerClassName; // The name of the class from which this call is being made (null for

  // external)

  // Constructor with caller class name
  public PhpMethodCallNode(
      PhpExpressionNode objectNode,
      String methodName,
      PhpExpressionNode[] argumentNodes,
  ...
  public PhpMethodCallNode(
      PhpExpressionNode objectNode, String methodName, PhpExpressionNode[] argumentNodes) {
  ...
  public Object execute(VirtualFrame frame) {
    ...
    if (!phpClass.hasMethod(methodName)) {
      ...
      throw new RuntimeException(
          "Call to undefined method: " + phpClass.getName() + "::" + methodName + "()");
    }
