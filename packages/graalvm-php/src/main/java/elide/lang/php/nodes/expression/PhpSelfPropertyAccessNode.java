...
/**
 * AST node for accessing static properties using self:: keyword.
 *
 * <p>Syntax: self::$propertyName
 *
 * <p>This node accesses static properties of the current class.
 */
public final class PhpSelfPropertyAccessNode extends PhpExpressionNode {

  private final String propertyName;
  private final String currentClassName; // The class from which self:: is being called

  public PhpSelfPropertyAccessNode(String propertyName, String currentClassName) {
  ...
  public Object execute(VirtualFrame frame) {
    ...
    return currentClass.getStaticPropertyValue(propertyName);
  }
}
