...
/** AST node for writing static class properties. Syntax: ClassName::$propertyName = value */
public final class PhpStaticPropertyWriteNode extends PhpExpressionNode {
  ...
  public PhpStaticPropertyWriteNode(
      String className, String propertyName, PhpExpressionNode valueNode) {
