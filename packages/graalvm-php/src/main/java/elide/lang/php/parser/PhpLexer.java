 ...
 *
 * <p>Provides low-level token scanning and position management for the PHP parser. Handles
 * whitespace, comments, keywords, and basic token matching.
 */
public final class PhpLexer {
  ...
  /** Set the current position in the source code. Used for lookahead and backtracking. */
  ...
  /** Consume and return the current character. Tracks line numbers when encountering newlines. */
  public char advance() {
  ...
  /**
   * Match a keyword, ensuring it's followed by a word boundary. Use this for matching PHP keywords
   * to avoid matching prefixes of identifiers.
   *
   * @return true if matched and consumed, false otherwise
   */
  @TruffleBoundary
  ...
  /**
   * Expect a specific string at the current position. Skips whitespace first, then throws an
