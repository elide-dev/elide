 ...
 *
 * <p>Supports: - Scalar types: int, float, string, bool - Special types: array, callable, void,
 * mixed, null - Class types: ClassName - Nullable types: ?int, ?ClassName - Union types (future):
 * string|int
 */
        ...
        if (value instanceof PhpObject && currentClassName != null) {
          ...
          if (currentClass != null && currentClass.getParentClass() != null) {
            return ((PhpObject) value)
                .getPhpClass()
                .getName()
                .equals(currentClass.getParentClass().getName());
          }
        }
        return false;
