...
import elide.runtime.gvm.internals.vfs.AbstractGuestVFS
...
internal class GuestIOConfiguration(
  ...
  internal companion object {
    ...
    /** Default root path. */
    const val DEFAULT_ROOT: String = AbstractGuestVFS.ROOT_SYSTEM_DEFAULT

    /** Default working directory path. */
    const val DEFAULT_WORKING_DIRECTORY: String = AbstractGuestVFS.DEFAULT_CWD
