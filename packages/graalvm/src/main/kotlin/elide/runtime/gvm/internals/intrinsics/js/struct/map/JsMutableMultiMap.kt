...
@Suppress("unused")
internal class JsMutableMultiMap<K : Any, V> constructor(
  ...
  @Suppress("unused")
  internal companion object Factory : MapFactory<JsMutableMultiMap<*, *>> {
     ...
     */
    @JvmStatic override fun <K : Any, V> copyOf(map: Map<K, V>) = JsMutableMultiMap(
     ...
     */
    @JvmStatic override fun <K : Any, V> fromPairs(
    ...
    @JvmStatic
    fun <K : Any, V> empty(size: Int): JsMutableMultiMap<K, V> = JsMutableMultiMap(mapImpl(size))
    ...
    @Suppress("UNCHECKED_CAST")
    @JvmStatic
    override fun <K : Any, V> empty(): JsMutableMultiMap<K, V> = EMPTY_MAP as JsMutableMultiMap<K, V>
  }
