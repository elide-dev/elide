 ...
 */
package elide.runtime.gvm.internals.node.zlib
...
@Intrinsic @Factory internal class NodeZlibModule : AbstractNodeBuiltinModule() {
  @Singleton internal fun provide(): ZlibAPI = NodeZlib.obtain()
 ...
 * # Node API: `zlib`
 */
internal class NodeZlib : ZlibAPI {
  //

  internal companion object {
    private val SINGLETON = NodeZlib()
    fun obtain(): NodeZlib = SINGLETON
  }
}
