 ...
 */
@Serializable
@JvmInline public value class JsSymbol private constructor (private val data: Pair<String, Boolean>) :
  Symbol,
  Comparable<Symbol>,
  java.io.Serializable {

  /** Module-public constructor. */
  internal constructor(name: String, internal: Boolean = true) : this(name to internal)
  ...
  public companion object JsSymbols {
    ...
    @DelicateElideApi @JvmStatic public fun String.asPublicJsSymbol(): JsSymbol = asJsSymbol(false)

    /** @return JS symbol wrapping the receiving string. */
    @JvmStatic public fun String.asJsSymbol(internal: Boolean = true): JsSymbol = JsSymbol(this to internal)
  }
