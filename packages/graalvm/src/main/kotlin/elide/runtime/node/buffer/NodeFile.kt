 ...
 */
@DelicateElideApi public class NodeFile private constructor(
  bytes: ByteArray,
  type: String?,
   ...
   */
  @Polyglot public constructor(sources: PolyglotValue, fileName: PolyglotValue) : this(
    sources = sources,
    fileName = fileName,
    options = null,
  )
   ...
   */
  @Polyglot public constructor(sources: PolyglotValue, fileName: PolyglotValue, options: PolyglotValue?) : this(
