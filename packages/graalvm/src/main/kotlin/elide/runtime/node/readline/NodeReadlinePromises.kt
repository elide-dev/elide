...
@Intrinsic
@Factory internal class NodeReadlinePromisesModule : AbstractNodeBuiltinModule() {
  @Singleton internal fun provide(): ReadlinePromisesAPI =
    NodeReadlinePromises.Companion.obtain()
...
internal class NodeReadlinePromises : ReadlinePromisesAPI {
  ...
  internal companion object {
    ...
    fun obtain(): NodeReadlinePromises =
      SINGLETON
  }
}
