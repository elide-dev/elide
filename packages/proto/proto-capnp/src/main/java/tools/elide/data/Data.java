    ...
    public static final class Builder extends org.capnproto.StructBuilder {
      ...
      public final tools.elide.crypto.Crypto.HashAlgorithm getHash() {
        switch (_getShortField(0)) {
          case 0:
            return tools.elide.crypto.Crypto.HashAlgorithm.IDENTITY;
          case 1:
            return tools.elide.crypto.Crypto.HashAlgorithm.MD5;
          case 2:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA1;
          case 3:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA2;
          case 4:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA256;
          case 5:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA384;
          case 6:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA512;
          case 7:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA3224;
          case 8:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA3256;
          case 9:
            return tools.elide.crypto.Crypto.HashAlgorithm.SHA3512;
          default:
            return tools.elide.crypto.Crypto.HashAlgorithm._NOT_IN_SCHEMA;
        }
      }
      ...
      public final tools.elide.data.Encodings.Encoding getEncoding() {
        switch (_getShortField(1)) {
          case 0:
            return tools.elide.data.Encodings.Encoding.UTF8;
          case 1:
            return tools.elide.data.Encodings.Encoding.UTF16;
          case 2:
            return tools.elide.data.Encodings.Encoding.UTF32;
          default:
            return tools.elide.data.Encodings.Encoding._NOT_IN_SCHEMA;
        }
      }
  ...
  public static class CompressedData {
    ...
    public static final class Builder extends org.capnproto.StructBuilder {
      ...
      public final tools.elide.data.Data.CompressionMode getCompression() {
        switch (_getShortField(0)) {
          case 0:
            return tools.elide.data.Data.CompressionMode.IDENTITY;
          case 1:
            return tools.elide.data.Data.CompressionMode.GZIP;
          case 2:
            return tools.elide.data.Data.CompressionMode.BROTLI;
          case 3:
            return tools.elide.data.Data.CompressionMode.SNAPPY;
          case 4:
            return tools.elide.data.Data.CompressionMode.DEFLATE;
          default:
            return tools.elide.data.Data.CompressionMode._NOT_IN_SCHEMA;
        }
      }
