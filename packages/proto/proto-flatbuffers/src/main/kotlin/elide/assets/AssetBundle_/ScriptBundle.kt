...
class ScriptBundle : Table() {
    ...
    fun asset(
      j: Int,
    ): elide.assets.AssetBundle_.ScriptBundle_.ScriptAsset? = asset(elide.assets.AssetBundle_.ScriptBundle_.ScriptAsset(), j)
    fun asset(
      obj: elide.assets.AssetBundle_.ScriptBundle_.ScriptAsset,
      j: Int,
    ): elide.assets.AssetBundle_.ScriptBundle_.ScriptAsset? {
        val o = __offset(6)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun addCompressable(
          builder: FlatBufferBuilder,
          compressable: Boolean,
        ) = builder.addBoolean(3, compressable, false)
