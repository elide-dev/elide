...
class LanguageSpecificMetadata : Table() {
    ...
    fun javascript(
      obj: elide.assets.EmbeddedScriptMetadata_.JsScriptMetadata,
    ): elide.assets.EmbeddedScriptMetadata_.JsScriptMetadata? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun getRootAsLanguageSpecificMetadata(
          _bb: ByteBuffer,
        ): LanguageSpecificMetadata = getRootAsLanguageSpecificMetadata(_bb, LanguageSpecificMetadata())
        fun getRootAsLanguageSpecificMetadata(
          _bb: ByteBuffer,
          obj: LanguageSpecificMetadata,
