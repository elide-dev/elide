...
class DataFingerprint : Table() {
    ...
    companion object {
        ...
        fun createDataFingerprint(builder: FlatBufferBuilder, hash: Int, saltOffset: Int, fingerprintOffset: Int) : Int {
        ...
        fun startDataFingerprint(builder: FlatBufferBuilder) = builder.startTable(3)
