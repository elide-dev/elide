...
class EndpointOptions : Table() {
    ...
    companion object {
        ...
        fun getRootAsEndpointOptions(
          _bb: ByteBuffer,
        ): EndpointOptions = getRootAsEndpointOptions(_bb, EndpointOptions())
        ...
        fun addPrecompilable(
          builder: FlatBufferBuilder,
          precompilable: Boolean,
        ) = builder.addBoolean(1, precompilable, false)
