...
class GeneralLanguageSettings : Table() {
    ...
    companion object {
        ...
        fun getRootAsGeneralLanguageSettings(
          _bb: ByteBuffer,
        ): GeneralLanguageSettings = getRootAsGeneralLanguageSettings(_bb, GeneralLanguageSettings())
        ...
        ) = builder.addBoolean(1, disableCache, false)
