...
class AppManifest : Table() {
  ...
  fun relatedApplication(j: Int): elide.page.Context_.AppManifest_.RelatedApplication? =
    relatedApplication(elide.page.Context_.AppManifest_.RelatedApplication(), j)
  ...
  companion object {
    ...
    fun addPreferRelatedApplications(builder: FlatBufferBuilder, preferRelatedApplications: Boolean) =
      builder.addBoolean(10, preferRelatedApplications, false)

    fun addRelatedApplication(builder: FlatBufferBuilder, relatedApplication: Int) =
