...
class ClientHints : Table() {
  ...
  companion object {
    ...
    fun addDevicePixelRatio(builder: FlatBufferBuilder, devicePixelRatio: UInt) =
    ...
    fun addEffectiveConnectionType(builder: FlatBufferBuilder, effectiveConnectionType: Int) =
