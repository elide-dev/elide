...
class OpenGraph : Table() {
  ...
  fun image(j: Int): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage? =
    image(elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage(), j)

  fun image(
    obj: elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage,
    j: Int
  ): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage? {
    val o = __offset(22)
    return if (o != 0) {
  ...
  fun video(j: Int): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo? =
    video(elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo(), j)

  fun video(
    obj: elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo,
    j: Int
  ): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo? {
    val o = __offset(24)
    return if (o != 0) {
      obj.__assign(__indirect(__vector(o) + j * 4), bb)
    } else {
