...
class OpenGraph : Table() {
    ...
    fun image(
      j: Int,
    ): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage? = image(elide.page.Context_.Metadata_.OpenGraph_.OpenGraphImage(), j)
    fun image(
    ...
    fun video(
      j: Int,
    ): elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo? = video(elide.page.Context_.Metadata_.OpenGraph_.OpenGraphVideo(), j)
    fun video(
