...
class GuestVFSConfig : Table() {
  ...
  companion object {
    ...
    fun addSymbolicLinks(builder: FlatBufferBuilder, symbolicLinks: Boolean) =
      builder.addBoolean(1, symbolicLinks, false)

    fun addCaseSensitive(builder: FlatBufferBuilder, caseSensitive: Boolean) =
    ...
    fun addWorkingDirectory(builder: FlatBufferBuilder, workingDirectory: Int) =
