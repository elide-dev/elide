...
class SafeHtmlProto : Table() {
    ...
    fun privateDoNotAccessOrElseSafeHtmlWrappedValueInByteBuffer(
      _bb: ByteBuffer,
    ...
    companion object {
        ...
        fun createSafeHtmlProto(
          builder: FlatBufferBuilder,
          privateDoNotAccessOrElseSafeHtmlWrappedValueOffset: Int,
        ): Int {
        ...
        fun addPrivateDoNotAccessOrElseSafeHtmlWrappedValue(
          builder: FlatBufferBuilder,
          privateDoNotAccessOrElseSafeHtmlWrappedValue: Int,
        ) = builder.addOffset(0, privateDoNotAccessOrElseSafeHtmlWrappedValue, 0)
