...
class SafeStyleSheetProto : Table() {
    ...
    fun privateDoNotAccessOrElseSafeStyleSheetWrappedValueInByteBuffer(
      _bb: ByteBuffer,
    ): ByteBuffer = __vector_in_bytebuffer(_bb, 4, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_22_12_06()
        fun getRootAsSafeStyleSheetProto(
          _bb: ByteBuffer,
        ): SafeStyleSheetProto = getRootAsSafeStyleSheetProto(_bb, SafeStyleSheetProto())
