...
class TrustedResourceUrlProto : Table() {
    ...
    fun privateDoNotAccessOrElseTrustedResourceUrlWrappedValueInByteBuffer(
      _bb: ByteBuffer,
    ): ByteBuffer = __vector_in_bytebuffer(_bb, 4, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_22_12_06()
        fun getRootAsTrustedResourceUrlProto(
          _bb: ByteBuffer,
        ): TrustedResourceUrlProto = getRootAsTrustedResourceUrlProto(_bb, TrustedResourceUrlProto())
