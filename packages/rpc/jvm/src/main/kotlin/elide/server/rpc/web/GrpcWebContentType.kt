 ...
 */
enum class GrpcWebContentType constructor (internal val symbol: String) {
  /**
   ...
   */
  fun contentType(proto: Boolean = true): String {
    return if (proto) {
      "$symbol+proto"
    } else {
      this.symbol
   ...
   */
  fun mediaType(proto: Boolean = true): MediaType {
    return MediaType(
      contentType(proto)
    )
  }
