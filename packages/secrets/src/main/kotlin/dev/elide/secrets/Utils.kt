...
internal object Utils {
    ...
    fun generateBytes(size: Int): ByteString =
        ByteString(ByteArray(size).apply { SecureRandom().nextBytes(this) })

    /**
     * Lists strings from [options] to [console's][console] output, then reads user's choice from
     * input and invokes the selected option's lambda. Loops if invalid input is given.
     */
