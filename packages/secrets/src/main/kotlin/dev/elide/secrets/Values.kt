...
internal object Values {
  ...
  const val REMOTE_ACCESS_SECRET = "remote:access"
  ...
  const val SELECT_ACCESS_IMPORT_MESSAGE =
    "Please select the access file you want to import.\n" +
      "Please note that for GPG-encrypted access files, only the ones that you have a private key for on this system will be displayed."
  ...
  const val SECRETS_NOT_INITIALIZED_EXCEPTION = "Secrets are not initialized, please run \"elide secrets\" first."
