 ...
 *     void *(*xFetch)(sqlite3_pcache *, unsigned int, int);
 *     void (*xUnpin)(sqlite3_pcache *, void *, int);
 *     void (*xRekey)(sqlite3_pcache *, void *, unsigned int, unsigned int);
...
public class sqlite3_pcache_methods {
    ...
    ).withName("sqlite3_pcache_methods");
    ...
    private static final long pArg$OFFSET = 0;
    ...
    private static final long xInit$OFFSET = 8;
    ...
    private static final long xShutdown$OFFSET = 16;
    ...
    public static class xCreate {
         ...
         * Invoke the upcall stub {@code funcPtr}, with given parameters
         */
        public static MemorySegment invoke(MemorySegment funcPtr,int _x0, int _x1) {
            try {
    ...
    private static final long xCreate$OFFSET = 24;
    ...
    private static final long xCachesize$OFFSET = 32;
    ...
    private static final long xPagecount$OFFSET = 40;
    ...
    private static final long xFetch$OFFSET = 48;
    ...
    private static final long xUnpin$OFFSET = 56;
    ...
    private static final long xRekey$OFFSET = 64;
    ...
    private static final long xTruncate$OFFSET = 72;
    ...
    private static final long xDestroy$OFFSET = 80;
