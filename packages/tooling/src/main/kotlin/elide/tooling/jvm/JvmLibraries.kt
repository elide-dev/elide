...
public object JvmLibraries {
  public const val KOTLIN_VERSION: String = "2.2.0"
  ...
  public const val EMBEDDED_COROUTINES_VERSION: String = COROUTINES_VERSION
  public const val EMBEDDED_SERIALIZATION_VERSION: String = SERIALIZATION_VERSION
  ...
  public val baseCoordinates: Array<String> = arrayOf(
  ...
  public val testCoordinates: Array<Pair<String, String>> = arrayOf(
    ...
    KOTLIN_TEST to KOTLIN_VERSION,
    KOTLIN_TEST_JUNIT5 to KOTLIN_VERSION,
