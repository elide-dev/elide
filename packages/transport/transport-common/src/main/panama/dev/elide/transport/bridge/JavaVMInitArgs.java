...
public class JavaVMInitArgs {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        netty_jni_util_h.C_INT.withName("version"),
        netty_jni_util_h.C_INT.withName("nOptions"),
        netty_jni_util_h.C_POINTER.withName("options"),
        netty_jni_util_h.C_CHAR.withName("ignoreUnrecognized"),
