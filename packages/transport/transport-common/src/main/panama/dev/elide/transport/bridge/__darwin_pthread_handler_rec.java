...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        netty_jni_util_h.C_POINTER.withName("__routine"),
        netty_jni_util_h.C_POINTER.withName("__arg"),
        netty_jni_util_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = netty_jni_util_h.upcallHandle(__routine.Function.class, "apply", $DESC);
