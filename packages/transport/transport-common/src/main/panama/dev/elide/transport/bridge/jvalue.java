...
public class jvalue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        netty_jni_util_h.C_CHAR.withName("z"),
        netty_jni_util_h.C_CHAR.withName("b"),
        netty_jni_util_h.C_SHORT.withName("c"),
        netty_jni_util_h.C_SHORT.withName("s"),
        netty_jni_util_h.C_INT.withName("i"),
        netty_jni_util_h.C_LONG.withName("j"),
        netty_jni_util_h.C_FLOAT.withName("f"),
        netty_jni_util_h.C_DOUBLE.withName("d"),
        netty_jni_util_h.C_POINTER.withName("l")
    ).withName("jvalue");
