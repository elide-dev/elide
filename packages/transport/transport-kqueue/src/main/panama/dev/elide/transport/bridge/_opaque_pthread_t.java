...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        netty_unix_util_h.C_LONG.withName("__sig"),
        netty_unix_util_h.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, netty_unix_util_h.C_CHAR).withName("__opaque")
