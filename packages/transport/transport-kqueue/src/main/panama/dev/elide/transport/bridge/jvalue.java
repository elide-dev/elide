...
public class jvalue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        netty_unix_util_h.C_CHAR.withName("z"),
        netty_unix_util_h.C_CHAR.withName("b"),
        netty_unix_util_h.C_SHORT.withName("c"),
        netty_unix_util_h.C_SHORT.withName("s"),
        netty_unix_util_h.C_INT.withName("i"),
        netty_unix_util_h.C_LONG.withName("j"),
        netty_unix_util_h.C_FLOAT.withName("f"),
        netty_unix_util_h.C_DOUBLE.withName("d"),
        netty_unix_util_h.C_POINTER.withName("l")
    ).withName("jvalue");
