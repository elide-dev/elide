...
JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_joinGroup(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray groupAddress, jbyteArray interfaceAddress, jint scopeId, jint interfaceIndex) {
    netty_io_uring_linuxsocket_joinGroup(env, clazz, fd, ipv6, groupAddress, interfaceAddress, scopeId, interfaceIndex);
};

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_joinSsmGroup(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray groupAddress, jbyteArray interfaceAddress, jint scopeId, jint interfaceIndex, jbyteArray sourceAddress) {
    netty_io_uring_linuxsocket_joinSsmGroup(env, clazz, fd, ipv6, groupAddress, interfaceAddress, scopeId, interfaceIndex, sourceAddress);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_leaveGroup(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray groupAddress, jbyteArray interfaceAddress, jint scopeId, jint interfaceIndex) {
    netty_io_uring_linuxsocket_leaveGroup(env, clazz, fd, ipv6, groupAddress, interfaceAddress, scopeId, interfaceIndex);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_leaveSsmGroup(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray groupAddress, jbyteArray interfaceAddress, jint scopeId, jint interfaceIndex, jbyteArray sourceAddress) {
    netty_io_uring_linuxsocket_leaveSsmGroup(env, clazz, fd, ipv6, groupAddress, interfaceAddress, scopeId, interfaceIndex, sourceAddress);
}
...
JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpDeferAccept(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpDeferAccept(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isTcpQuickAck(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isTcpQuickAck(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isTcpCork(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isTcpCork(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getSoBusyPoll(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getSoBusyPoll(env, clazz, fd);
}
...
JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpNotSentLowAt(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpNotSentLowAt(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpKeepIdle(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpKeepIdle(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpKeepIntvl(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpKeepIntvl(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpKeepCnt(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpKeepCnt(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpUserTimeout(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTcpUserTimeout(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getTimeToLive(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getTimeToLive(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isIpFreeBind(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isIpFreeBind(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isIpTransparent(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isIpTransparent(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isIpRecvOrigDestAddr(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isIpRecvOrigDestAddr(env, clazz, fd);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_getTcpInfo(JNIEnv* env, jclass clazz, jint fd, jlongArray array) {
    netty_io_uring_linuxsocket_getTcpInfo(env, clazz, fd, array);
}

JNIEXPORT jobject Java_io_netty_incubator_channel_uring_LinuxSocket_getPeerCredentials(JNIEnv *env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_getPeerCredentials(env, clazz, fd);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_isTcpFastOpenConnect(JNIEnv* env, jclass clazz, jint fd) {
    return netty_io_uring_linuxsocket_isTcpFastOpenConnect(env, clazz, fd);
}
...
JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpDeferAccept(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpDeferAccept(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpQuickAck(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpQuickAck(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpCork(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpCork(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setSoBusyPoll(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setSoBusyPoll(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpNotSentLowAt(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpNotSentLowAt(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpFastOpen(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpFastOpen(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpFastOpenConnect(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpFastOpenConnect(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpKeepIdle(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpKeepIdle(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpKeepIntvl(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpKeepIntvl(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpKeepCnt(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpKeepCnt(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpUserTimeout(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTcpUserTimeout(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setIpFreeBind(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setIpFreeBind(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setIpTransparent(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setIpTransparent(env, clazz, fd, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setIpRecvOrigDestAddr(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setIpRecvOrigDestAddr(env, clazz, fd, optval);
}
...
JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTcpMd5Sig(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray address, jint scopeId, jbyteArray key) {
    netty_io_uring_linuxsocket_setTcpMd5Sig(env, clazz, fd, ipv6, address, scopeId, key);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setInterface(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jbyteArray interfaceAddress, jint scopeId, jint interfaceIndex) {
    netty_io_uring_linuxsocket_setInterface(env, clazz, fd, ipv6, interfaceAddress, scopeId, interfaceIndex);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getInterface(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6) {
    return netty_io_uring_linuxsocket_getInterface(env, clazz, fd, ipv6);
}

JNIEXPORT jint Java_io_netty_incubator_channel_uring_LinuxSocket_getIpMulticastLoop(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6) {
    return netty_io_uring_linuxsocket_getIpMulticastLoop(env, clazz, fd, ipv6);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setIpMulticastLoop(JNIEnv* env, jclass clazz, jint fd, jboolean ipv6, jint optval) {
    netty_io_uring_linuxsocket_setIpMulticastLoop(env, clazz, fd, ipv6, optval);
}

JNIEXPORT void Java_io_netty_incubator_channel_uring_LinuxSocket_setTimeToLive(JNIEnv* env, jclass clazz, jint fd, jint optval) {
    netty_io_uring_linuxsocket_setTimeToLive(env, clazz, fd, optval);
}
