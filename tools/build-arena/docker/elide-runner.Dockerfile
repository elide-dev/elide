# Elide Runner Docker Image
# Minimal base image - Claude Code will download and install Elide during the race
...
# Copy Elide-specific Claude Code instructions
...
RUN echo 'if [ -t 1 ]; then' >> /home/builder/.bashrc && \
    echo '  echo -e "\033[1;35m=== ELIDE RUNNER ===\033[0m"' >> /home/builder/.bashrc && \
    ...
    echo '  echo -e "\033[1;36mElide:\033[0m NOT INSTALLED (will download during race)"' >> /home/builder/.bashrc && \
    echo '  echo -e "\033[1;33mMission: Download Elide, build project, report time\033[0m"' >> /home/builder/.bashrc && \
