 ...
 */
public final class DataFingerprint
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return tools.elide.data.Data.internal_static_data_DataFingerprint_fieldAccessorTable.ensureFieldAccessorsInitialized(
            tools.elide.data.DataFingerprint.class,
            tools.elide.data.DataFingerprint.Builder.class
        );
    }
    ...
    public int getSerializedSize() {
        ...
        if (hash_ != tools.elide.crypto.HashAlgorithm.IDENTITY.getNumber()) {
            size +=
                com.google.protobuf.CodedOutputStream.computeEnumSize(1, hash_);
        }
        if (!salt_.isEmpty()) {
            size +=
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!getSalt().equals(other.getSalt())) return false;
    ...
    public static Builder newBuilder(
        tools.elide.data.DataFingerprint prototype
    ) {
    ...
    public static final class Builder
        ...
        public tools.elide.data.DataFingerprint buildPartial() {
            tools.elide.data.DataFingerprint result = new tools.elide.data.DataFingerprint(
                this
            );
            result.hash_ = hash_;
            result.salt_ = salt_;
        ...
        public Builder mergeFrom(tools.elide.data.DataFingerprint other) {
            if (
                other == tools.elide.data.DataFingerprint.getDefaultInstance()
            ) return this;
            if (other.hash_ != 0) {
            ...
            if (
                other.getFingerprint() != com.google.protobuf.ByteString.EMPTY
            ) {
        ...
        public Builder mergeFrom(
            ...
            try {
                ...
                parsedMessage =
                    (tools.elide.data.DataFingerprint) e.getUnfinishedMessage();
    ...
    private static final com.google.protobuf.Parser<DataFingerprint> PARSER = new com.google.protobuf.AbstractParser<DataFingerprint>() {
        @java.lang.Override
