 ...
 */
public final class PersistenceOptions extends
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return tools.elide.model.Datamodel.internal_static_model_PersistenceOptions_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            tools.elide.model.PersistenceOptions.class, tools.elide.model.PersistenceOptions.Builder.class);
  }
  ...
  public static tools.elide.model.PersistenceOptions parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static tools.elide.model.PersistenceOptions parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(tools.elide.model.PersistenceOptions prototype) {
  ...
  public static final class Builder extends
    ...
    public tools.elide.model.PersistenceOptions buildPartial() {
      tools.elide.model.PersistenceOptions result = new tools.elide.model.PersistenceOptions(this);
      result.mode_ = mode_;
      result.path_ = path_;
    ...
    public Builder mergeFrom(tools.elide.model.PersistenceOptions other) {
      if (other == tools.elide.model.PersistenceOptions.getDefaultInstance()) return this;
      if (other.mode_ != 0) {
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (tools.elide.model.PersistenceOptions) e.getUnfinishedMessage();
